...
namespace DarkDefenders.Client.Presenters
{
    internal class GamePresenter : IRemoteEvents
    {
        ...
        private readonly Dictionary<IdentityOf<RemoteEntity>, RigidBodyPresenter> _presentersMap = new Dictionary<IdentityOf<RemoteEntity>, RigidBodyPresenter>();

        private Vector _lastCreaturePosition = Vector.Zero;
        private IdentityOf<RemoteEntity> _playersRigidBodyId;
